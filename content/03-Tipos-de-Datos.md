...
<div class="nav-bar nav-top">
  <a class="nav-pill nav-left" href="/02-Estructura-General">← 02 — Estructura General de un Algoritmo</a>
  <a class="nav-pill nav-home" href="/00-Indice-Principal">⌂</a>
  <a class="nav-pill nav-right" href="/04-Variables-e-Identificadores">04 — Variables e Identificadores →</a>
</div>
